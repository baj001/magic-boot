...
<!--              <mb-select v-model="genInfo.columns" :options="tables" />-->
            </el-form-item>
          </el-col>
          <el-col :span="8">
...
<!--    <el-tabs v-model="activeName">-->
<!--      <el-tab-pane label="表信息" name="basic">-->
<!--&lt;!&ndash;      <el-tab-pane label="表信息" name="basic">&ndash;&gt;-->
<!--        <el-row :gutter="24">-->
<!--&lt;!&ndash;          <el-col :span="8">&ndash;&gt;-->
<!--&lt;!&ndash;            <el-form-item label="数据源" prop="datasource">&ndash;&gt;-->
<!--&lt;!&ndash;              <mb-select v-model="genInfo.datasource" url="/system/code/gen/database" />&ndash;&gt;-->
